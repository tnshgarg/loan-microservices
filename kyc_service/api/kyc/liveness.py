...
from kyc_service.dependencies.kyc import gdrive_upload_service, s3_upload_service, google_sheets_service
...
async def upload_profile_pic(
    ...
    if liveness_check_result == "SUCCESS":
        return {"message": "Liveness check successful"}
    else:
        return {"message": "Liveness check failed"}
